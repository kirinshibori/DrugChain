        ...
        <v-app>
            ...
            <v-app-bar app color="primary" dark>
                ...
                <v-btn id="title-dapp" @click="startTour" target="_blank" text>
                    <H1><strong>DrugChain: Pharma Supply Chain</strong></H1>
                </v-btn>

                <v-spacer></v-spacer>
                <v-btn href="https://github.com/kirinshibori/DrugChain" target="_blank" text>
...
var Web3app = {
    ...
    processUpcStatusEvt: function (m, e) {
        switch (e.event) {
            ...
            case 'GrapeProcessed':
                m.sts.fa_proc = false
                m.sts.pr_cr = true // hold ingredient values to DrugRefined
                break
            // Ingredient workflow -------------------
            case 'JuiceCreated':
                m.sts.pr_ble = true
...
export default {
    ...
    data: () => ({
        ...
        sm_acc: {
            sm: {
                addr: '0x4DF57E0D3Fdd839223445A965c77F1FE3E1b5A24'
            }
        },
        ...
        user_acc: {
            owner: {
                ...
                addr: '0x0BC85Ee983E7098Ceb32a775B81299f047d54e8b',
                addr_txt: '',
                priv: 'e4bb1c210c4c8fad76b6b1050d50b2330a55324b3e6cc0f22d80ff2b0d766ea8',
                id: 'b-owner',
            ...
            fa: {
                ...
                l: 'farmer address',
                addr_txt: '',
                addr: '0xAE156929a21876Bce20c660bc00C4E3B364675cb',
                priv: 'a5342dba0ff2068c619c54c0c336ff90363156bb192310d41d814256fad24eb3',
                id: 'b-farmer',
                items: [
                    { id: 2, k: 'fa_plant', text: 'Source Raw Material', icon: 'fas fa-seedling' },
                    { id: 3, k: 'fa_harv', text: 'Produce Ingredient', icon: 'fas fa-tractor' },
                    { id: 4, k: 'fa_proc', text: 'Process Ingredient', icon: 'fas fa-box-open' }
                ],
            ...
            in: {
                ...
                l: 'Inspector address',
                addr: '0x62266D32D909CBdB2E21687cAbeb42e587a2Dc90',
                addr_txt: '',
                priv: 'f0c4612dc0f8cba648b05c1dd769cdcd135c4293a0218d9d537c58a7f63d0c84',
                id: 'b-inspector',
                items: [
                    { id: 5, k: 'in_aud', text: 'Audit Ingredient', icon: 'fas fa-tag' },
                    { id: 6, k: 'in_cer', text: 'Certify Drug', icon: 'fas fa-check-square' }
                ],
            ...
            pr: {
                ...
                avatar: 'manufacturer.jpg',
                l: 'Manufacturer address',
                addr: '0x0AB6626aD6aCAE7dc28C8CE25aD675691AF54f62',
                addr_txt: '',
                priv: '9a0df1cab9eb0c60ecffdb89caf77de43f1dfbff8b5b93ee1d3f37e53b5e799b',
                id: 'b-producer',
                items: [
                    { id: 7, k: 'pr_cr', text: 'Create a Drug', icon: 'fas fa-flask' },
                    { id: 8, k: 'pr_ble', text: 'Refine a Drug', icon: 'fas fa-glass-cheers' },
                    { id: 9, k: 'pr_pr', text: 'Produce a Drug', icon: 'fas fa-industry' },
                    { id: 10, k: 'pr_pack', text: 'Pack a Drug', icon: 'fas fa-shipping-fast' }
                ],
            ...
            di: {
                ...
                addr: '0x91872783f21b7Ca40ee785369b88Ae43452b72E5',
                addr_txt: '',
                priv: 'd1c429fa17ec658f497103eb85cccb457e85aaa9a849e47284bc41787a2931a9',
                id: 'b-distributor',
                items: [{ id: 11, k: 'di_sell', text: 'For Drug Sale', icon: 'fas fa-store' }],
            ...
            co: {
                ...
                avatar: 'consumer.jpg',
                l: 'Consumer address',
                addr: '0x4a4b2d9Cb5c64a8c959ee9c4385A02CB8Bad44b5',
                addr_txt: '',
                priv: 'f6a7951881575d6e4ba34486d5f7d686ad3d2fc2821e35223410e1b7f0d6457c',
                id: 'b-consumer',
                items: [
                    { id: 12, k: 'co_buy', text: 'Buy a Drug', icon: 'fas fa-shopping-cart' }],
                items_unlocked: [false],
                v: false,
                vt: '',
                vs: 'color:black',
        ...
        FarmPlant_params: {
            t1: { t: 'Ingredient' },
            grapeUpc: { l: 'ingredientUpc - Universal Product Code (unique number for each Ingredient sourced)', v: 1 },
            t2: { t: 'Supplier' },
            originFarmName: { l: 'Supplier Name (text)', v: 'GlaxoSmithKline Singapore' },
            originFarmInformation: { l: 'Supplier Information (text)', v: '38 Quality Rd, Singapore 618809' },
            originFarmLatitude: { l: 'Supplier Latitude', v: 1.335232 },
            originFarmLongitude: { l: 'Supplier Latitude', v: 103.7078023 }
        },
        FarmHarvest_params: {
            t1: { t: 'Ingredient' },
            grapeUpc: { l: 'ingredientUpc - Universal Product Code (unique number for each Ingredient planted)', v: 1 },
            t2: { t: 'Produce' },
            harvestNotes: { l: 'Ingredient Notes (text)', v: 'details here important ingredient notes' }
        },
        FaProc_params: {
            t1: { t: 'Ingredient' },
            grapeUpc: { l: 'ingredientUpc - Universal Product Code (unique number for each Ingredient Sourced)', v: 1 }
        ...
        InAudit_params: {
            t1: { t: 'Ingredient' },
            grapeUpc: { l: 'ingredientUpc - Select the upc of Ingredient', v: 1 },
            t2: { t: 'Audit' },
            auditNotes: { l: 'Audit Notes (text)', v: 'details here important audit notes' }
        },
        InCert_params: {
            t1: { t: 'Drug' },
            juiceUpc: { l: 'drugUpc - Select the upc of Drug', v: 1 },
            t2: { t: 'Certify' },
            certifyNotes: { l: 'Certify Notes (text)', v: 'details here important certify notes' }
        },
        PrCre_params: {
            t1: { t: 'Create Drug' },
            juiceUpc: { l: 'drugUpc - Universal Product Code (unique number for each Drug Produced)', v: 1 },
        ...
        PrBle_params: {
            ...
            juiceUpc: { l: 'drugUpc - Select the upc of Drug', v: 1 },
            t2: { t: 'Refine Drug' },
            grapeUpc: { l: 'ingredientUpc - Select the upc of Ingredient to Refine the Drug', v: 1 }
        },
        PrPack_params: {
            t1: { t: 'Drug' },
            juiceUpc: { l: 'drugUpc - Select the upc of Drug', v: 1 }
        ...
        PrPro_params: {
            t1: { t: 'Juice' },
            juiceUpc: { l: 'drugUpc - Select the upc of Drug', v: 1 },
            t2: { t: 'Drug Product info' },
            productNotes: { l: 'Drug product notes (text)', v: 'details here important product notes' },
