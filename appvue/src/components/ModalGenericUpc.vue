            ...
            <v-dialog v-model="dialog" persistent max-width="850px">
                <v-card>
                    ...
                    <v-card-text>
                        <v-container>
                            ...
                            <div v-for="(n, index) in params" v-bind:key="index">
                                <v-row>
                                    ...
                                    <!-- checkForm result message - only for ingredientUpc field -->
                        ...
                        *You should set the address of your Metamask wallet to <strong>the appropriate role</strong>, network <strong>Rinkeby</strong> and have <strong>enough funds</strong>.
                    </v-card-text>
                    <v-card-actions>
                        <v-spacer></v-spacer>
    ...
    methods: {
        ...
        checkForm() {
            ...
            if ([3, 4, 5].includes(this.item.id)) {
                // Selects ingredientUpc: check if ingredientUpc exists
                ...
                // New drugUpc: check if drugUpc not exists
                ...
                // Selects drugUpc: check if drugUpc exists
                console.log('p.juiceUpc.v')
                console.log(p.juiceUpc.v)
