    ...
    <div class="component">
        ...
        <table style="width: 100%; border: 1px solid black">
            <tr style="border: 1px solid black">
                <th style="border: 1px solid black">Ingredients Events</th>
                <th style="border: 1px solid black">Drugs Events</th>
            </tr>
        ...
        <table style="width: 100%; border: 1px solid black">
            <tr style="border: 1px solid black">
                ...
                <th style="border: 1px solid black">Drugs</th>
            </tr>
                ...
                <th style="border: 1px solid black">
                    <tr v-for="(n, index) in upc_actions_grapes" v-bind:key="index">
                        <td style="text-align: left">
                            ...
                            <span v-if="index == 'fa_plant'"> upcIngredient: any new</span>
                ...
                <th style="border: 1px solid black">
                    <tr v-for="(n, index) in upc_actions_juices" v-bind:key="index">
                        <td style="text-align: left">
                            ...
                            <span v-if="index == 'pr_cr'"> upcDrug: any new</span>
